...
def main(args):
    ...
    with torch.no_grad():
        ...
        vocgan_trace.save(
            "{}/vocgan_ex_female_en_{}_{}.pt".format(
                args.out, checkpoint["githash"], checkpoint["epoch"]
            )
        )
        # audio = model(mel)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-o", "--out", type=str, required=True, help="path of output pt file"
    )
