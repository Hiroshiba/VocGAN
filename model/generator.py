...
class VOCGenerator(nn.Module):
    def __init__(
        ...
        self.res_stack_1 = nn.Sequential(
        ...
        self.res_stack_2 = nn.Sequential(
            *[ResStack(mult, dilation=3**j) for j in range(n_residual_layers)]
        )
        ...
        self.skip_upsample_1 = nn.utils.weight_norm(
            nn.ConvTranspose1d(
                mel_channel,
                mult,
                kernel_size=64,
        ...
        self.res_stack_3 = nn.Sequential(
            *[ResStack(mult, dilation=3**j) for j in range(n_residual_layers)]
        )
        ...
        self.skip_upsample_2 = nn.utils.weight_norm(
            nn.ConvTranspose1d(
                mel_channel,
                mult,
                kernel_size=128,
        ...
        self.res_stack_4 = nn.Sequential(
            *[ResStack(mult, dilation=3**j) for j in range(n_residual_layers)]
        )
        ...
        self.skip_upsample_3 = nn.utils.weight_norm(
            nn.ConvTranspose1d(
                mel_channel,
                mult,
                kernel_size=256,
        ...
        self.res_stack_5 = nn.Sequential(
            *[ResStack(mult, dilation=3**j) for j in range(n_residual_layers)]
        )
        ...
        self.skip_upsample_4 = nn.utils.weight_norm(
            nn.ConvTranspose1d(
                mel_channel,
                mult,
                kernel_size=512,
        ...
        self.res_stack_6 = nn.Sequential(
            *[ResStack(mult, dilation=3**j) for j in range(n_residual_layers)]
        )
...
if __name__ == "__main__":
    ...
    assert out.shape == torch.Size(
        [3, 1, 2560]
    )  # For normal melgan torch.Size([3, 1, 2560])
